					...
					<!-- <div class="more-setting-rows"> -->
						...
						<div class="mystickyelements-content-section-wrap">
							...
							<div class="myStickyelements-inputs myStickyelements-label myStickyelements-time-delay">
								...
								&nbsp;<input type="number" name="general-settings[timer_delay_sec]" style="width: 133px;border-radius: 10px;display:<?php echo isset($general_settings['time_delay']) ? 'inline-flex' : 'none';?>" value="<?php echo ( isset($general_settings['timer_delay_sec']) && $general_settings['timer_delay_sec'] != '' ) ? $general_settings['timer_delay_sec'] : '0' ; ?>" <?php if(isset($general_settings['time_delay']) && $general_settings['time_delay'] != 1 ): ?> disabled="disabled" <?php endif; ?>>
							</div>
