				...
				<div class="mystickyelement-lists-wrap">
					<ul class="mystickyelements-lists <?php echo esc_attr('mysticky' . $minimize_class);?>">
						...
						<?php if (isset($contact_form['enable']) && $contact_form['enable'] == 1): ?>
							...
							<li id="mystickyelements-contact-form" class="mystickyelements-contact-form <?php echo esc_attr($contact_form_class); ?>"  <?php if (isset($contact_form['direction']) && $contact_form['direction'] == 'RTL') : ?> dir="rtl" <?php endif; ?> data-tab-opt="<?php echo $general_settings["open_tabs_when"]; ?>" >
								<?php 
									...
									<form id="stickyelements-form" action="" method="post" autocomplete="off">
										...
										if (isset($contact_form['phone']) && $contact_form['phone'] == 1): ?>
											<input
												...
												<input type="hidden" id="phone_formate" value="<?php echo (isset($contact_form['phone_formate']) && $contact_form['phone_formate'] == 1) ? 1 : 0; ?>">
